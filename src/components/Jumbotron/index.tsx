    ...
    <>
      <div className="hero-container">
        ...
        <div className="hero-title mx-[18px] mt-9 mb-5">
          <h2 className="text-very-dark-blue text-4xl font-semibold">
            Building dev team, Quikcly and Affordably
          </h2>
        </div>

        <div className="hero-subtitle px-[18px] my-[21px]">
          <p className="text-very-dark-blue text-xl font-light">
            We specializie in helping you build a team of expert developers,
